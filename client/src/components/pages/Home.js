...
const Landing = () => {
    return (<div style={{ textAlign: 'center',marginTop:50 }}><i><h1 style={{fontWeight:'bold'}}>Student Information Chatbot</h1></i>
        <div style={{marginTop:20}}>
            <div style={{float:'left',width:500,display:'inline',textIndent: '15px',textAlign: 'justify',letterSpacing: '1px',fontFamily:'Bookman, URW Bookman L, serif',fontWeight:'500',fontSize: 'larger',lineHeight: '1.5'}}>
